...
test.log(Status.PASS, MarkupHelper.createLabel("OHRMLogin:Pass", ExtentColor.GREEN));
...
test.log(Status.FAIL, MarkupHelper.createLabel("OHRMLogin:Fail", ExtentColor.RED));
